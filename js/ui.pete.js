  ...
  **/
  ...
  var Ui = Class({
    initialize: function() {
      ...
      //@pete FOR...
      // this.config.buttonSlots is global anyway
      this._generateGrid();
    },
    /**
    ...
    draw:function (input) {
      ...
      //console.log(ui_unit);
        ...
        //display buttons
        //slot 1: attack
        //@pete REMOVED NOT SURE WHAT IT DOES if(input.offense) {console.log("attack");
        //@pete REMOVED NOT SURE WHAT IT DOES   this.btnArray[0][0].disabled = false;
        //@pete REMOVED NOT SURE WHAT IT DOES }
        if(input.offense) {
            console.log("attack");
            this.btnArray[0].disabled = false;
        }
        //slot 2: stop
        //slot 3: move
        //@pete REMOVED NOT SURE WHAT IT DOES if(input.move) {console.log("move");
        //@pete REMOVED NOT SURE WHAT IT DOES   this.btnArray[1][0].disabled = false;
        //@pete REMOVED NOT SURE WHAT IT DOES   this.btnArray[2][0].disabled = false;
        //@pete REMOVED NOT SURE WHAT IT DOES }
        if(input.move) {
            console.log("move");
            this.btnArray[4].disabled = false;
            this.btnArray[7].disabled = false;
        }
        //slot 9: build menu
        //@pete REMOVED NOT SURE WHAT IT DOES if(Object.keys(input.builder).length > 0) {console.log("build");
        //@pete REMOVED NOT SURE WHAT IT DOES   this.btnArray[2][2].disabled = false;
        //@pete REMOVED NOT SURE WHAT IT DOES }
        if(Object.keys(input.builder).length > 0) {
            console.log("build");
            this.btnArray[2].disabled = false;
        }
    ...
    _generateGrid:function() {
      //@pete MOVED THIS TO THE INITIALIZOR AS IT LOOKS TO BE A GBL VAR this.btnArray = [];
      /*
      @pete //REPLACED
      ...
      @pete //FOR...
      We now have a 1D array, indexed 0-8 (slot = 3, slots = 3*3[9])
      */
      for (var i = 0, t = this.config.buttonSlots*this.config.buttonSlots; i < t; i++) {
          this.btnArray[i] = new Button;
      }
    },
    /**
      * _clearStage
    ...
    _clearStage: function() {
        ...
        */
        for(var i = 0, t = this.config.buttonSlots*this.config.buttonSlots; i < t; i++) {
            this.btnArray[i].disabled = true;
            this.btnArray[i].removeBtn(this.stage);
        }
    },
    /**
      * toString
